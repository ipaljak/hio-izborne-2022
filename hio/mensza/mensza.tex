...
``Alojzije, najprije ću tebe pozvati u svoj ured i pokazat ću ti prirodan
  broj $A$.  Zatim ćeš mi ti na papir napisati niz prirodnih brojeva $a = (a_1, a_2,
...
``Benjamine, tebe ću sljedećeg pozvati u ured i pokazat ću ti prirodan
  broj $B \ne A$.  Zatim ćeš mi ti na papir napisati niz prirodnih brojeva $b = (b_1, b_2,
...
$a$ koji predstavljaju niz prirodnih brojeva koje bi Alojzije napisao na papir nakon što
...
predstavljaju niz prirodnih brojeva koje bi Benjamin napisao na papir nakon što mu gospodin
